        ...
        <div class="card shadow p-4" style="width: 100%; max-width: 400px;">
            ...
            <form id="registration-form" method="post" action="/registration/checkuser" enctype="multipart/form-data">
                <div class="d-flex flex-column align-items-center">
                    <img id="profileImage" src="/public/images/icons/upload-photo.svg" alt="Фото профиля" class="img-fluid rounded-circle mb-3 mt-3"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="login" name="login" value="<?= htmlspecialchars($formData['login'] ?? '') ?>"
