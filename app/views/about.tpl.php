<body>
    <div class='conatiner-fluid d-flex flex-column justify-content-center align-items-center mt-5'>
        ...
        <div>
            <h1>Ваши <span class='text-primary'>моменты</span>, наша галерея.</h1>
            <p>Мы верим, что каждая фотография — это не просто изображение, а отражение чувств, моментов и воспоминаний. Pixels создан для тех, кто хочет делиться своими визуальными историями с миром. Здесь каждый кадр находит свою аудиторию, а каждый автор — признание.</p>
        </div>
        <img src='./public/images/assets/aboutImg.jpg' width='500' height='300' alt='aboutImg' class='img-fluid rounded'>
    </div>

        <div class='container-fluid d-flex flex-row justify-content-center align-items-center gap-5'>
